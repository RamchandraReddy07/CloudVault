...
function AuraIllustration() {
  return (
    <svg
      viewBox="0 0 800 600"
      className="w-full h-auto drop-shadow-2xl transform hover:scale-105 transition-transform duration-1000"
      aria-hidden="true"
    >
      <defs>
      ...
      <g className="animate-pulse" style={{ animationDuration: "3s" }}>
        <path
          d="M400,300 L600,150 M400,300 L200,150 M400,300 L400,100"
          stroke="#e2e8f0"
          strokeWidth="2"
      ...
      <g className="animate-bounce" style={{ animationDuration: "6s" }}>
        <path
          d="M620,180 L660,160 L660,200 L620,220 Z"
          fill="#fff"
          stroke="#e2e8f0"
        />
        <path
          d="M660,160 L700,180 L700,220 L660,200 Z"
          fill="#f8fafc"
          stroke="#e2e8f0"
        />
        <path
          d="M620,180 L660,200 L700,180 L660,160 Z"
          fill="#f1f5f9"
          stroke="#e2e8f0"
        />
      </g>
      ...
      >
        <path
          d="M120,200 L160,180 L160,220 L120,240 Z"
          fill="#fff"
          stroke="#e2e8f0"
        />
        <path
          d="M160,180 L200,200 L200,240 L160,220 Z"
          fill="#f8fafc"
          stroke="#e2e8f0"
        />
        <path
          d="M120,200 L160,220 L200,200 L160,180 Z"
          fill="#f1f5f9"
          stroke="#e2e8f0"
        />
      </g>
    ...
    <div className="bg-white min-h-screen selection:bg-sky-100 selection:text-sky-900">
      <nav className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-500 to-emerald-400 flex items-center justify-center shadow-lg shadow-sky-100">
            <svg
          ...
          <span className="text-2xl font-extrabold tracking-tighter text-slate-900 uppercase">
            CloudVault
          </span>
        </div>
        ...
        <button
          onClick={onStart}
          className="px-6 py-3 bg-slate-900 text-white text-xs font-black uppercase tracking-widest rounded-xl hover:bg-sky-600 transition-all shadow-xl shadow-slate-200"
        >
          Sign In
        </button>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="text-left">
              ...
              <h2 className="text-6xl md:text-8xl font-extrabold text-slate-900 tracking-tight mb-10 leading-[0.95] text-balance">
                Breathe light{" "}
              ...
              <p className="text-xl text-slate-500 max-w-lg mb-14 leading-relaxed font-medium">
                CloudVault is a specialized file engine for the next generation
                of web applications. Move assets directly to S3 with
            ...
            <div className="relative">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-sky-100 rounded-full blur-[120px] opacity-60 -z-10" />
              <AuraIllustration />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 border-y border-slate-50 bg-slate-50/20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-wrap justify-between items-center opacity-30 grayscale gap-10">
            {["Amazon S3", "Node.js", "DynamoDB", "Lambda", "React"].map(
              (brand) => (
                <span
                  key={brand}
                  className="text-xl font-black tracking-tighter uppercase italic text-slate-900"
                >
                  {brand}
                </span>
              )
