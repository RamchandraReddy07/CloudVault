        ...
        <div className="bg-white rounded-[3.5rem] shadow-[0_32px_120px_-20px_rgba(14,165,233,0.12)] border border-white overflow-hidden p-3">
          <div className="bg-[#f8fafc] rounded-[3rem] p-12 border border-slate-100">
            <div className="text-center mb-10">
              <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-sky-500 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-emerald-100">
                <svg
            ...
            <div className="mt-10 text-center">
              <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">
                ...
                <button
                  ...
                  className="text-sky-600 hover:text-sky-700 transition-colors ml-1 font-black underline decoration-2 underline-offset-4"
                >
                  Connect Here
                </button>
              </p>
