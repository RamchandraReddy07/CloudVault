      ...
      <header className="bg-white/70 backdrop-blur-2xl border-b border-slate-100 sticky top-0 z-50 px-6">
        <div className="max-w-7xl mx-auto h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 bg-gradient-to-br from-sky-500 to-emerald-400 rounded-2xl flex items-center justify-center shadow-xl shadow-sky-100">
              <svg
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-slate-900 tracking-tighter uppercase leading-none">
                CloudVault
              </h1>
            ...
            <div className="flex items-center gap-8">
              <div className="hidden sm:flex flex-col items-end">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-[9px] text-emerald-600 font-black uppercase tracking-widest px-2 py-0.5 bg-emerald-50 rounded-md">
                    Live Session
                  </span>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-6 h-6 bg-sky-50 rounded flex items-center justify-center text-sky-600 text-[10px] font-black italic">
                C
              </div>
          ...
          <div className="flex flex-col md:items-end gap-2">
            <p className="text-[11px] text-slate-300 font-bold uppercase tracking-[0.2em]">
              &copy; {new Date().getFullYear()} CloudVault Global Infra.
            </p>
