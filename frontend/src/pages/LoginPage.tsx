        ...
        <div className="bg-white rounded-[3.5rem] shadow-[0_32px_120px_-20px_rgba(14,165,233,0.12)] border border-white overflow-hidden p-3">
          <div className="bg-[#f8fafc] rounded-[3rem] p-12 border border-slate-100">
            <div className="text-center mb-12">
              <div className="w-20 h-20 bg-linear-to-br from-sky-500 to-emerald-400 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl shadow-sky-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                {loading ? <div className="w-7 h-7 border-4 border-white/30 border-t-white rounded-full animate-spin"></div> : 'Connect'}
              </button>
            </form>
            ...
            <div className="mt-10 text-center">
              <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">
                New Operator?{' '}
                <button onClick={onSwitchToSignup} className="text-emerald-600 hover:text-emerald-700 transition-colors ml-1 font-black underline decoration-2 underline-offset-4">
                  Initialize Identity
                </button>
              </p>
            </div>
